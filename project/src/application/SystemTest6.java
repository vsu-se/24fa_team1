...
public class SystemTest6 extends Application {
    ...
    public void setUp() throws Exception {
        ...
        items.add(new Item("Expired Item", "1 kg", "Expired Description", new Category("Category 4"), "Used", "Tag1", "Tag2", "Tag3", LocalDateTime.now().minusDays(5), LocalDateTime.now().minusDays(1), 50.0));
    }
