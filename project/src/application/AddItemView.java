...
public class AddItemView {
	...
	public AddItemView(AuctionSystemView parentView) {
		this.parentView = parentView;
		tab = generateTab();
		AddItemEventHandlers eventHandlers = new AddItemEventHandlers(this);
	}
	...
	public Tab generateTab() {
        ...
        categoryComboBox = new ComboBox<>(parentView.getController().getCategories());
        ...
        return new Tab("Add Item", layout);
	}
    ...
    public AuctionSystemView getParentView() {
    	return parentView;
    }
