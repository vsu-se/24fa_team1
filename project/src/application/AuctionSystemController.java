...
public class AuctionSystemController {
	...
	public void checkAndUpdateAuctions() {
        for (Auction auction : system.getAuctions()) {
            ...
            if(!auction.isActive()) { //add closed categories to concluded auctions box
            	if(!system.getConcludedCategories().contains(auction.getCategory())) {
            		system.getConcludedCategories().add(auction.getCategory());
            	}
            }
        }
        Platform.runLater(() -> {
	...
	public void updateConcludedAuctionsDisplay() { //working?? W
            ...
            if (selectedCategory == null || auction.getCategory().equals(selectedCategory)) {
                if (auction.isActive()) {
                	...
                	bidHistoryButton.setOnAction(event -> {
                    	...
                    	BidHistoryTab bidHistoryView = new BidHistoryTab(auction); //FIXME UGLY FR, make more like others 
