...
public class AuctionSystemControllerTest {
    ...
    private UpdateScheduler mockScheduler;
    ...
    void setUp() {
        ...
        controller = new AuctionSystemController(mockView);
    ...
    void testAddCategory() {
        ...
        assertFalse(mockSystem.getCategories().contains(newCategory));

        // Add category using the controller
        controller.addCategory(newCategory);

        // Verify that the category was added
        assertTrue(mockSystem.getCategories().contains(newCategory));
    }
